import {AccountConfig, MetamaskPolkadotRpcRequest, SnapConfig} from "@nodefactory/metamask-polkadot-types";
...
export const EmptyMetamaskState: () => MetamaskState = () => ({polkadot: {account: {publicKey: ""}, config: null}});
